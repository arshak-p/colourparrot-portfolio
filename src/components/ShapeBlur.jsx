...
float getLogoSDF(in vec2 p, in float R, in float r) {
    ...
    // Flat-capped quarter arcs terminating cleanly at the axes
...
const ShapeBlur = ({
  ...
  useEffect(() => {
    ...
    const material = new THREE.ShaderMaterial({
      ...
      uniforms: {
        ...
        u_glowColor: { value: colorObj },
        u_baseOpacity: { value: baseOpacity }
      },
  ...
  }, [variation, pixelRatioProp, shapeSize, roundness, borderSize, circleSize, circleEdge, glowColor, baseOpacity]);
